class ApiConstants {
  static const String baseUrl = "http://10.52.102.237:8001";
  ...
  static const String profileEmailRequest = "$baseUrl/users/profile/email/request";
  static const String profileEmailVerify = "$baseUrl/users/profile/email/verify";
